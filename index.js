...
const phoneNumber = config.pairingNumber || config.ownerNumber || "923315462969";
...
global.botname = config.botName || "M-ZAHID-MD";
global.themeemoji = "•";
    ...
    try {
        ...
        QasimDev.ev.on('connection.update', async (s) => {
            ...
            if (connection === "open") {
                ...
                printLog('info', `[ ${config.botName || 'M-ZAHID-MD'} ]`);
...
async function main() {
    ...
    printLog('info', 'Starting M ZAHID MD BOT...');
