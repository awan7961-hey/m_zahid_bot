...
const config = {
    // Bot Identity
    botName: process.env.BOT_NAME || 'M-ZAHID-MD',
    botOwner: process.env.BOT_OWNER || 'M ZAHID',
    ownerNumber: process.env.OWNER_NUMBER || '923315462969',
    author: process.env.AUTHOR || 'M ZAHID',
    packname: process.env.PACKNAME || 'M-ZAHID-MD',
    ...
    // Links
    channelLink: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029VbBhyp7BfxoEclHqI33Y',
    updateZipUrl: process.env.UPDATE_URL || 'https://github.com/m-ZAHID-mods/ZAHID-mdx-bot/archive/refs/heads/main.zip',
    ytChannel: process.env.YT_CHANNEL || 'M ZAHID',
    // Session
