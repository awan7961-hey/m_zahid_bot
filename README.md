...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=M-ZAHID-MD&fontSize=72&fontColor=fff&animation=twinkling&fontAlignY=32&desc=High%20Performance%20WhatsApp%20Bot&descAlignY=55&descSize=20" width="100%"/>
...
[![Version](https://img.shields.io/badge/Version-6.0.0-blue?style=for-the-badge&logo=github)](https://github.com/me9900-say/ZAHID-mdx-bot)
...
[![Stars](https://img.shields.io/github/stars/m-ZAHID-mods/ZAHID-mdx-bot?style=for-the-badge&logo=starship&color=gold)](https://github.com/me9900-say/ZAHID-mdx-bot/stargazers)
[![Forks](https://img.shields.io/github/forks/m-ZAHID-mods/ZAHID-mdx-bot?style=for-the-badge&logo=git&color=orange)](https://github.com/me9900-say/ZAHID-mdx-bot/network/members)
...
```bash
git clone https://github.com/me9900-say/ZAHID-mdx-bot.git
cd ZAHID-mdx-bot
npm install
cp sample.env .env
...
```env
SESSION_ID=m-ZAHID-mods/ZAHID-mdx-bot_xxxxxxxxxxxxxxxxxxxxxxxx
```
...
```env
# ── REQUIRED (choose one) ────────────────────────────────────
SESSION_ID=m-ZAHID-mods/ZAHID-mdx-bot_your_gist_id_here
# OR
PAIRING_NUMBER=923001234567
...
```bash
sudo bash <(curl -fsSL https://raw.githubusercontent.com/m-ZAHID-mods/ZAHID-mdx-bot/main/lib/install.sh)
```
> [!IMPORTANT]
...
```bash
# After install:
nano /root/ZAHID-mdx-bot/.env
cd /root/ZAHID-mdx-bot && pm2 start dist/index.js --name m-ZAHID-md
...
tmux new -s m-ZAHID-md    # Start new session
npm start

# Detach:     Ctrl+B → D
# Re-attach:  tmux attach -t m-ZAHID-md
# List:       tmux ls
# Kill:       tmux kill-session -t m-ZAHID-md
```
...
# Keep alive with PM2
npm install -g pm2
pm2 start dist/index.js --name m-ZAHID-md
pm2 save && pm2 startup
```
...
| Command | Description |
|---|---|
| `pm2 logs m-ZAHID-md` | Live logs |
| `pm2 restart m-ZAHID-md` | Restart |
| `pm2 stop m-ZAHID-md` | Stop |
...
2. Paste: `https://github.com/me9900-say/ZAHID-mdx-bot`
3. Open **Secrets** tab (🔒) and add:

   | Key | Value |
   |---|---|
   | `SESSION_ID` | `m-ZAHID-mods/ZAHID-mdx-bot_your_gist_id` |
...
**One-line Deployer:**
```bash
bash <(curl -s https://raw.githubusercontent.com/m-ZAHID-mods/ZAHID-mdx-bot/main/lib/heroku.sh)
```
**Manual:**
```bash
heroku login
...
heroku config:set SESSION_ID=m-ZAHID-mods/ZAHID-mdx-bot_your_gist_id
...
**One-line Deployer:**
```bash
bash <(curl -s https://raw.githubusercontent.com/m-ZAHID-mods/ZAHID-mdx-bot/main/lib/fly.sh)
```
**Manual:**
```bash
...
fly secrets set SESSION_ID=m-ZAHID-mods/ZAHID-mdx-bot_your_gist_id
...
```bash
# Build image
docker build -t m-ZAHID-md .

# Run
docker run -d \
  -e SESSION_ID=m-ZAHID-mods/ZAHID-mdx-bot_your_gist_id \
...
```env
# MongoDB
MONGO_URL=mongodb+srv://user:password@cluster.mongodb.net/mZAHIDmd

# PostgreSQL
POSTGRES_URL=postgresql://user:password@host:5432/mZAHIDmd

# MySQL
MYSQL_URL=mysql://user:password@host:3306/mZAHIDmd
...
| `BOT_NAME` | ❌ | `M-ZAHID-MD` | Bot display name |
| `BOT_OWNER` | ❌ | `M ZAHID` | Owner display name |
| `PACKNAME` | ❌ | `M-ZAHID-MD` | Sticker pack name |
...
export default {
    ...
    async handler(sock: any, message: any, args: any[], context: any = {}) {
        const {
            ...
            channelInfo       // M-ZAHID-MD branding spread
        } = context;
...
> [!IMPORTANT]
> - Verify `SESSION_ID` starts with `m-ZAHID-mods/ZAHID-mdx-bot_`
...
[![Telegram](https://img.shields.io/badge/Telegram-FF0000?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/zaiditech)
[![WhatsApp](https://img.shields.io/badge/WhatsApp_Channel-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://whatsapp.com/channel/0029VbBhyp7BfxoEclHqI33Y)
[![GitHub Issues](https://img.shields.io/badge/GitHub_Issues-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/me9900-say/ZAHID-mdx-bot/issues)
...
[MIT License](LICENSE) · Made with ❤️ by **M ZAHID** · [M ZAHID](https://github.com/me9900-say)
